...
--close active editor
keymap.set('n', '<leader>x', "<cmd> lua require('vscode').action('workbench.action.closeActiveEditor')<CR>",
  { desc = "close active editor" })


--tab navigation
keymap.set({ 'n' }, '<leader>tn', "<cmd>lua require('vscode').action('workbench.action.nextEditor')<CR>",
  { desc = 'goto next tab' })
keymap.set({ 'n' }, '<leader>tp', "<cmd>lua require('vscode').action('workbench.action.previousEditor')<CR>",
  { desc = 'goto prev tab' })
...
keymap.set({ 'n', 'v' }, "<leader>tt", "<cmd> lua require('vscode').action('workbench.action.terminal.focus')<CR>",
  { desc = "focus in the terminal" })


--explor
keymap.set({ 'n', 'v' }, "<leader>ee", "<cmd> lua require('vscode').action('workbench.view.explorer')<CR>",
  { desc = "focus in the terminal" })
...
--code actions
keymap.set('n', '<C-.>', "<cmd> lua require('vscode').action('editor.action.quickFix')<CR>",
  { desc = "access the quickfix list" })
--toggle hide and unhide the side bar
keymap.set({ 'n', 'v' }, "<leader>hb",
